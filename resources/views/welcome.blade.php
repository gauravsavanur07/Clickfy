...
<div class="col s6 offset-s6  m6 offset-m6">
  <div class="card blue-grey darken-1">
    <div class="card-content white-text">
      <h6 class="card-title center-align">News Feed</h6>
      <?php
...
echo'  <div class="card-image">';
  ...
  echo '  <span class="card-title">'.$sites['description'].'</span>';
echo '</div>';
  echo'<div class="card-action  deep-orange accent-1>';
echo'<a  class="waves-effect waves-light btn"><i class="material-icons left">cloud</i>Comment</a>';
